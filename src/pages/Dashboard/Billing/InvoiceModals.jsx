            ...
            <div className="space-y-5">
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { label: 'Generated By', value: (typeof invoice.generatedBy === 'object' ? (invoice.generatedBy?.name || `${invoice.generatedBy?.firstName || ''} ${invoice.generatedBy?.lastName || ''}`.trim() || invoice.generatedBy?.email) : (invoice.generatedByName || invoice.generatedBy)) || 'Society Admin' },
                ].map(({ label, value }) => (
